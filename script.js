...
const WeatherSnap = () => {
    const [temperature] = React.useState(N.rand(23, 30));
...
const Reminder = () => {
    return (React.createElement("div", { className: "reminder" },
        React.createElement("div", { className: "reminder-icon" },
            React.createElement("i", { className: "fa-regular fa-industry" })),
        React.createElement("span", { className: "reminder-text" },
            "Sistema Integral Contable ",
            React.createElement("span", { className: "reminder-time" }, "True Factory Group "))));
};
const Time = () => {
...
const Weather = () => {
            ...
            const getIcon = () => {
                switch (day.weather) {
                    case WeatherType.Cloudy:
                        return "fa-duotone fa-network-wired";
                    case WeatherType.Rainy:
                        return "fa-duotone fa-industry";
    ...
    return (React.createElement(MenuSection, { icon: "fa-solid fa-industry", id: "weather-section", scrollable: true, title: "Sistema Integral de de Facturacion para miembros de La Factoria" }, getDays()));
};
const Tools = () => {
    const getTools = () => {
        return [{
                ...
                id: 1,
                image: "https://images.unsplash.com/photo-1555396273-367ea4eb4db5?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=500&q=60",
                label: "Comidas",
                name: "Locales"
            }, {
                icon: "fa-solid fa-cup-togo",
                id: 2,
                image: "https://images.unsplash.com/photo-1550630997-aea8d3d982ed?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=500&q=60",
                label: "Alimentos",
                name: "Lacteos"
            }, {
                icon: "fa-solid fa-jedi",
                id: 3,
                image: "https://images.unsplash.com/photo-1562869929-bda0650edb1f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=500&q=60",
                label: "Textiles",
                name: "Accesorios"
            }, {
                icon: "fa-solid fa-bottle-droplet",
                id: 4,
                image: "https://plus.unsplash.com/premium_photo-1661758946219-dcf3e31e557d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=500&q=60",
                label: "Servicios",
                name: "Varios"
            }, {
                icon: "fa-solid fa-industry",
                id: 5,
                image: "https://images.unsplash.com/photo-1511978293554-7b92f19bd77d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=500&q=60",
                label: "Comidas",
                name: "Ambulantes"
            }, {
                icon: "fa-solid fa-jar",
                id: 6,
                image: "https://images.unsplash.com/photo-1583944009439-57f0bb0168cf?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=500&q=60",
                label: "Alimentos",
                name: "Conservas"
            }].map((tool) => {
            const styles = {
    ...
    return (React.createElement(MenuSection, { icon: "fa-solid fa-toolbox", id: "tools-section", title: "Cual es tu rubro?" }, getTools()));
};
const Restaurants = () => {
    const getRestaurants = () => {
        return [{
                desc: "Lo mejor en comidas rapidas",
                id: 1,
                image: "https://images.unsplash.com/photo-1529006557810-274b9b2fc783?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=500&q=60",
                title: "Paparuchi"
            }, {
                desc: "Los mejores helados del mundo",
                id: 2,
                image: "https://images.unsplash.com/photo-1602296750425-f025b045f355?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=500&q=60",
                title: "Milkshakes&Cream"
            }, {
                desc: "El Mojito unico lo encuentras aqui",
                id: 3,
                image: "https://images.unsplash.com/photo-1541745038731-f1c2b5a1a49e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=500&q=60",
                title: "Mojitos&Tea"
            }, {
                desc: "Comida Goutmet en un solo lugar",
                id: 4,
                image: "https://images.unsplash.com/photo-1529543544282-ea669407fca3?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=500&q=60",
                title: "The Best of"
            }].map((restaurant) => {
            const styles = {
    ...
    return (React.createElement(MenuSection, { icon: "fa-regular fa-pot-food", id: "restaurants-section", title: "Nuestras Empresas Destacadas del Mes" }, getRestaurants()));
};
const Movies = () => {
    const getMovies = () => {
        return [{
                desc: "Seremos una verdadera Fabrica, pero una factoria de Sueños, y asi poder cumplir las metas de todos los emprendedores y soñadores tambien.",
                id: 1,
                icon: "fa-solid fa-galaxy",
                image: "https://images.unsplash.com/photo-1491975474562-1f4e30bc9468?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w500&q=60",
                title: "Vision"
            }, {
                desc: "Ayudar a la poblacion mas necesitada y todos aquellos que entran en los grupos mas vulnerables de la sociedad.",
                id: 2,
                icon: "fa-solid fa-hat-wizard",
                image: "https://images.unsplash.com/photo-1634254008113-68dc2e78290a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w500&q=60",
                title: "Mision"
            }, {
                desc: "Nos regimos a unas metodologias bien marcadas, basadas en el diseño grafico para lograr todas nuestras metas",
                id: 3,
                icon: "fa-solid fa-broom-ball",
                image: "https://plus.unsplash.com/premium_photo-1677093905854-6347243e9b05?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8cG9saWNpZXMlMjBidXNpbmVzc3xlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=500&q=60",
                title: "Politicas"
            }, {
                desc: "Abarcamos la gran mayoria de las areas empresariales, pero nos enfocamos en las microempresas, como el eje fundamental para erradicar la pobreza y la desigualdad",
                id: 4,
                icon: "fa-solid fa-starship-freighter",
                image: "https://images.unsplash.com/photo-1445592460430-2c4c1b620e6a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=500&q=60",
                title: "Areas"
            }].map((movie) => {
            const styles = {
    ...
    return (React.createElement(MenuSection, { icon: "fa-solid fa-industry", id: "movies-section", scrollable: true, title: "Nuestras Premisas" }, getMovies()));
};
    ...
    return (React.createElement("div", { id: "app-menu" },
        React.createElement("div", { id: "app-menu-content-wrapper" },
            React.createElement("div", { id: "app-menu-content" },
                ...
                React.createElement("a", { id: "youtube-link", className: "clear-button", href: "https://www.youtube.com/@TrueFactoryGroup", target: "_blank" },
                    React.createElement("i", { className: "fa-brands fa-youtube" }),
                    React.createElement("span", null, "True Factory Group")),
